"use strict";
(self["webpackChunkmy_web"] = self["webpackChunkmy_web"] || []).push([["src_pages_myAppsPage_index_jsx"],{
...
var index_js_ = __webpack_require__(93121);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
;// CONCATENATED MODULE: ./src/pages/myAppsPage/index.module.less
// extracted by mini-css-extract-plugin
/* harmony default export */ const index_module = ({"page":"src-pages-myAppsPage-index-module__page","tools":"src-pages-myAppsPage-index-module__tools","info":"src-pages-myAppsPage-index-module__info"});
// EXTERNAL MODULE: ./src/utils/request.js
var request = __webpack_require__(96648);
;// CONCATENATED MODULE: ./src/pages/myAppsPage/service.js
/**
 * Service
 * @author
 */var queryPage=function queryPage(options){return new Promise(function(resolve,reject){(0,request/* default */.Z)({method:'POST',url:'/lowcodeApi/auth/page/query',type:'json',body:options}).then(function(res){resolve(res);});});};var removePage=function removePage(options){return new Promise(function(resolve,reject){(0,request/* default */.Z)({method:'POST',url:'/lowcodeApi/auth/page/remove',type:'json',body:options}).then(function(res){resolve(res);});});};var setHome=function setHome(options){return new Promise(function(resolve,reject){(0,request/* default */.Z)({method:'POST',url:'/lowcodeApi/auth/app/setHome',type:'json',body:options}).then(function(res){resolve(res);});});};var changeAuthor=function changeAuthor(options){return new Promise(function(resolve,reject){(0,request/* default */.Z)({method:'POST',url:'/lowcodeApi/auth/page/changeAuthor',type:'json',body:options}).then(function(res){resolve(res);});});};
...
;// CONCATENATED MODULE: ./src/pages/myAppsPage/index.jsx
function _typeof(obj){"@babel/helpers - typeof";if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);return Constructor;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function");}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,writable:true,configurable:true}});if(superClass)_setPrototypeOf(subClass,superClass);}function _setPrototypeOf(o,p){_setPrototypeOf=Object.setPrototypeOf||function _setPrototypeOf(o,p){o.__proto__=p;return o;};return _setPrototypeOf(o,p);}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=_getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=_getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget);}else{result=Super.apply(this,arguments);}return _possibleConstructorReturn(this,result);};}function _possibleConstructorReturn(self,call){if(call&&(_typeof(call)==="object"||typeof call==="function")){return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self){if(self===void 0){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct(){if(typeof Reflect==="undefined"||!Reflect.construct)return false;if(Reflect.construct.sham)return false;if(typeof Proxy==="function")return true;try{Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}));return true;}catch(e){return false;}}function _getPrototypeOf(o){_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function _getPrototypeOf(o){return o.__proto__||Object.getPrototypeOf(o);};return _getPrototypeOf(o);}/**
 * apps
 * @author tianyanrong
 * @date 2021/6/15 下午3:22:25
 */var Page=/*#__PURE__*/function(_Component){_inherits(Page,_Component);var _super=_createSuper(Page);function Page(){var _this;_classCallCheck(this,Page);for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}_this=_super.call.apply(_super,[this].concat(args));_this.state={};_this.getColumns=function(){_this.setState({columns:[{title:'页面名称',dataIndex:'pageName',key:'pageName',render:function render(text,recode){if(recode.url){return/*#__PURE__*/index_js_default().createElement("a",{href:recode.url,target:'_blank'},text);}else{return text;}}},{title:'页面ID',dataIndex:'fileName',key:'fileName'},{title:'页面缩略图',dataIndex:'thumbnail',key:'thumbnail',render:function render(text){return/*#__PURE__*/index_js_default().createElement("img",{src:text,style:{maxWidth:'40px',maxHeight:'40px'}});}},{title:'拥有者',dataIndex:'editAuthor',key:'editAuthor'},{title:'创建时间',dataIndex:'createdAt',key:'createdAt'},{title:'操作',key:'caozuo',render:function render(record){var globalModel=_this.props.globalModel;var userInfo=globalModel.userInfo||{};var isCanAuth=userInfo.role==='owner'||userInfo.role==='manager'||userInfo.accountCode===record.editAuthor;return/*#__PURE__*/index_js_default().createElement("div",null,record.isHome?/*#__PURE__*/index_js_default().createElement("span",{style:{marginRight:'15px',color:'#999'}},"\u5DF2\u4E3A\u9996\u9875"):/*#__PURE__*/index_js_default().createElement("a",{style:{marginRight:'15px'},onClick:function onClick(){_this.setHome(record.fileName);}},"\u8BBE\u7F6E\u4E3A\u9996\u9875"),isCanAuth?/*#__PURE__*/index_js_default().createElement("a",{style:{marginRight:'15px'},onClick:function onClick(){_this.setState({currentSelect:{editAuthor:record.editAuthor,fileName:record.fileName},selectMemberVisible:true});}},"\u8F6C\u6D3E"):null,isCanAuth?/*#__PURE__*/index_js_default().createElement(popconfirm/* default */.Z,{title:"\u786E\u5B9A\u5220\u9664\u6B64\u9875\u9762\uFF1F",onConfirm:function onConfirm(){_this.remove(record.fileName);},onCancel:function onCancel(){}},/*#__PURE__*/index_js_default().createElement("a",null,"\u5220\u9664")):null);}}]});};_this.changeAuthor=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee(options){var res;return regenerator_default().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return changeAuthor(options);case 2:res=_context.sent;if(res.result==='success'){message/* default.success */.ZP.success('转派成功！');_this.setState({selectMemberVisible:false,currentSelect:{}});_this.getData();}else{message/* default.error */.ZP.error(res&&res.message||'转派失败！');}case 4:case"end":return _context.stop();}}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}();_this.remove=/*#__PURE__*/function(){var _ref2=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee2(fileName){var res;return regenerator_default().wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return removePage({fileName:fileName});case 2:res=_context2.sent;if(res.result==='success'){message/* default.success */.ZP.success('删除成功！');_this.getData();}else{message/* default.error */.ZP.error(res&&res.message||'删除失败！');}case 4:case"end":return _context2.stop();}}},_callee2);}));return function(_x2){return _ref2.apply(this,arguments);};}();_this.setHome=/*#__PURE__*/function(){var _ref3=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee3(fileName){var res;return regenerator_default().wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return setHome({fileName:fileName});case 2:res=_context3.sent;if(res.result==='success'){message/* default.success */.ZP.success('首页设置成功！');_this.getData();}else{message/* default.error */.ZP.error(res&&res.message||'首页设置失败！');}case 4:case"end":return _context3.stop();}}},_callee3);}));return function(_x3){return _ref3.apply(this,arguments);};}();_this.getData=/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee4(){var res;return regenerator_default().wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_this.setState({loading:true});_context4.next=3;return queryPage();case 3:res=_context4.sent;if(res.result==='success'){_this.setState({data:res.data||[]});}_this.setState({loading:false});case 6:case"end":return _context4.stop();}}},_callee4);}));return _this;}_createClass(Page,[{key:"componentDidMount",value:function componentDidMount(){this.getColumns();this.getData();}},{key:"render",value:function render(){var _this2=this;var _this$state=this.state,_this$state$columns=_this$state.columns,columns=_this$state$columns===void 0?[]:_this$state$columns,_this$state$data=_this$state.data,data=_this$state$data===void 0?[]:_this$state$data,_this$state$loading=_this$state.loading,loading=_this$state$loading===void 0?false:_this$state$loading,_this$state$currentSe=_this$state.currentSelect,currentSelect=_this$state$currentSe===void 0?{}:_this$state$currentSe,selectMemberVisible=_this$state.selectMemberVisible;return/*#__PURE__*/index_js_default().createElement("div",{className:index_module.page},/*#__PURE__*/index_js_default().createElement("div",{className:index_module.tools}),/*#__PURE__*/index_js_default().createElement(table/* default */.Z,{loading:loading,columns:columns,dataSource:data,pagination:false,rowKey:function rowKey(record){return record.appLogId;}}),/*#__PURE__*/index_js_default().createElement(SelectMember/* default */.Z,{visible:selectMemberVisible,value:currentSelect.editAuthor,onCancel:function onCancel(){_this2.setState({selectMemberVisible:false,currentSelect:{}});},onOk:function onOk(value){_this2.changeAuthor({fileName:currentSelect.fileName,editAuthor:value});}}));}}]);return Page;}(index_js_.Component);/* harmony default export */ const myAppsPage = ((0,es/* connect */.$j)(function(_ref5){var globalModel=_ref5.globalModel;return{globalModel:globalModel};})(Page));
